...
export class TodoComponent implements OnInit {
  ...
  constructor(private db: DatabaseService, private factory: Factory) {
  }
  ...
  onSubmit() {
    ...
    const t: Task = this.factory.createTask(this.value, '4----', null);
    this.db.save({findId: null, table: 'tasks', row: t}).subscribe(r => console.log('result back ', r));
